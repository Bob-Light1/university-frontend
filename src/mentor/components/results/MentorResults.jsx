/**
 * @file MentorResults.jsx
 * @description Read-only published results for the mentor's assigned students.
 */
...
export default function MentorResults() {
  ...
  const fetchResults = useCallback(async () => {
    ...
    setError(null);
    try {
      const res = await getMyResults({ page, limit: LIMIT });
      ...
      <Stack direction="row" spacing={1.5} alignItems="center" sx={{ mb: 3 }}>
        ...
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Published results for your students (read-only)
          </Typography>
        </Box>
      </Stack>
