/**
 * @file TeacherProfile.jsx
 * @description Teacher portal — own profile management.
 *
 * Section 1 : Identity header (read-only: name, email, department)
...
export default function TeacherProfile() {
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 }, maxWidth: 760, mx: 'auto' }}>
      ...
      {/* ── Identity header ──────────────────────────────────────────────────── */}
      <Paper sx={{ p: 3, mb: 3, borderRadius: 3, background: 'linear-gradient(135deg, #00695c 0%, #26a69a 100%)', color: 'white' }}>
        <Stack direction="row" spacing={2.5} alignItems="center">
          <ProfileImageUploader
            currentImage={profile?.profileImage}
            signatureEndpoint="/teachers/me/upload-signature"
