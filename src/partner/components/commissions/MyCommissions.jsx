...
export default function MyCommissions() {
  ...
  const [downloading, setDownloading] = useState(null); // commissionId being downloaded
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 }, maxWidth: 1000, mx: 'auto' }}>
      ...
      <Typography variant="h5" fontWeight={800} sx={{ mb: 0.5 }}>My Commissions</Typography>
      ...
      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} sx={{ mb: 2.5 }}>
        {[
          { label: 'Pending',   value: pending,   icon: <HourglassEmpty />, color: '#ed6c02' },
          { label: 'Validated', value: validated, icon: <CheckCircle />,    color: '#0288d1' },
          { label: 'Paid',      value: paid,      icon: <Paid />,           color: '#2e7d32' },
          { label: `Paid Out (${commissions[0]?.currency ?? 'XAF'})`, value: totalAmount.toLocaleString(), icon: <AttachMoney />, color: '#7b1fa2' },
